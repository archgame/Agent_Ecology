...
public class QueueL1V2 : MonoBehaviour
{
    ...
    void Start()
    {
        board = GameObject.FindGameObjectWithTag("board2");
        getBoard = board.GetComponent<BoardV2>();
        if (targets.Length == 0)
        {
            //get all game objects tagged with "Target"
            targets = GameObject.FindGameObjectsWithTag("L3");
            targetsL2 = GameObject.FindGameObjectsWithTag("L4");
            i = targets.Length;
            j = targetsL2.Length;
